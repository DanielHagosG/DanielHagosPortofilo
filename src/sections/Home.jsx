  ...
  return (
    <section className="max-w-screen-lg mx-auto w-full pt-20 min-h-screen flex flex-col justify-between px-5 lg:px-0">
      <div data-aos="fade-in" className="flex flex-1 flex-col md:flex-row items-center justify-between gap-4">
        <Intro />
        <div className="">
          <img src="./img/cartoon.png" className="rounded-full overflow-hidden w-72 h-72" alt="Daniel pic" />
        </div>
      </div>
      <div data-aos="fade-in" data-aos-delay="100" className="flex py-8 justify-center md:justify-start items-center gap-4">
        <a target="_blank" href="linkedin.com/in/daniel-hagoss" className="fill-slate-600 md:hover:scale-110 md:transition md:hover:fill-sky-400" >
          <svg
        ...
        <a target="_blank" href="https://github.com/DanielHagosG" className="fill-slate-600 md:hover:scale-110 md:transition md:hover:fill-sky-400" >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
        ...
        <a href="./img/DanielHagosFStackdev.pdf" className="">
